...
var options = []option{
	...
	{"postgres.master.user", "string", "user", "postgres master user"},
	{"postgres.master.password", "string", "password", "postgres master password"},
	{"postgres.master.database_name", "string", "echo", "postgres master database name"},
	...
	{"postgres.replica.host", "string", "localhost", "postgres master host"},
	{"postgres.replica.port", "int", 5432, "postgres master port"},
	{"postgres.replica.user", "string", "user", "postgres master user"},
	{"postgres.replica.password", "string", "password", "postgres master password"},
	{"postgres.replica.database_name", "string", "echo", "postgres master database name"},
